...
from agent.sb3_fe import FeaturesExtractor
from agent.sb3_fe_test import EnhancedFeaturesExtractor
...
features_extractor_kwargs = dict(stack_size=5, features_dim=256)  # the output dimension of the features extractor
...
if __name__ == '__main__':
    ...
    user_experiment_name = 'no_safe_layer'
